...
2. Navigate to: `apps → tascok-headscale`.  
...
1. Go to the folder: `apps → tascok-headscale → config`.  
...
```bash
sudo docker exec -it tascok-headscale_headscale_1 headscale apikeys create
```
